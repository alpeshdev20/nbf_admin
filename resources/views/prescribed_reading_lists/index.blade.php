...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Reading Lists (Prescribed)</h1>
        <h1 class="pull-right">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{{ route('prescribedReadingLists.create') }}">Add New</a>
           &nbsp;&nbsp;<br>
		   <!--
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                    @include('prescribed_reading_lists.table')
            </div>
        </div>
