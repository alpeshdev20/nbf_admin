...
class app_material_ResourcesForAIDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
{
    ...
    return $dataTable->addColumn('select', function ($row) {
    ...
    public function html()
    {
        ...
        ->parameters([
            ...
            'buttons'   => [
                ...
                [
                    'text' => 'AI Integration',
                    'className' => 'btn btn-primary btn-sm no-corner btn-ai-integration',
                    'action' => 'function() { toggleAIIntegration(); }' ,
                ],
            ],
            'scrollX'   => true,
        ]);
    ...
    protected function getColumns()
    {
        ...
        return [
            'select' => ['title' => '<input type="checkbox" id="select-all">', 'orderable' => false, 'searchable' => false],
            'id',
            'material' => ['data' => 'booktype.material_type', 'name' => 'booktype.material_type'],
            'title' => ['data' => 'book_name', 'name' => 'book_name'],
            ...
            'ai_integration' => ['data' => 'ai_integration', 'name' => 'Ai Integration'],
