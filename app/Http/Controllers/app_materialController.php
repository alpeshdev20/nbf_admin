...
$countries = [];
    ...
    {   
        ...
        if($request->material_type == '2' || $request->material_type == '4' || $request->material_type == '5' || $request->material_type == '3' ) {
    ...
    public function edit($id)
    {
        ...
        if($appMaterial->material_type == '2' || $appMaterial->material_type == '4' || $appMaterial->material_type == '5' || $appMaterial->material_type == '3') {
